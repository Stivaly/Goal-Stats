    ...
    <div class="wrapper">
      ...
      <aside id="sidebar" class="w-auto" v-if="showNav">
        <div class="d-flex flex-column">
          <router-link id="toggle-btn" to="/dashboard/" class="sidebar-link-logo"  @click="toggleSidebar">
        ...
        <ul class="sidebar-nav">
          <li class="sidebar-item">
            <router-link id="toggle-btn" class="btn sidebar-link" to="/dashboard/profile/">
            ...
            <li class=" sidebar-item">
              <router-link id="toggle-btn" class="btn sidebar-link" to="/dashboard/users/">
            ...
            <li>
              <router-link id="toggle-btn" to="/#/" class="btn sidebar-link">
...
export default {
  ...
  computed: {
    showNav() {
      const routesWithNav = ['/dashboard/', '/dashboard/users/', '/dashboard/profile/']; // Lista de rutas donde se muestra el menú
